...
"""A simple human player for playing the `CleanUp Simple` level interactively.
...
from examples.tutorial.morl.configs.environment import morl_simple as game
...
def verbose_fn(unused_timestep, unused_player_index: int) -> None:#DOES NOT WORK
  pass

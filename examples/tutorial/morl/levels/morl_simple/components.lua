...
function DensityRegrow:__init__(kwargs)
    kwargs = args.parse(kwargs, {
        ...
        -- The name of the state representing the active or alive state of other object.
        {'liveStateOther', args.stringType},
    ...
    updaterRegistry:registerUpdater{
        ...
        updateFn = function()
            ...
            for _, object in pairs(objects) do
                print(object:getState(),  self._config.liveStateOther)
              if object:getState() == self._config.liveStateOther then
                liveNeighbors = liveNeighbors + 1
              end
            end
            print("LIVE: ",liveNeighbors)
